...
REQUIRED_SNAPSHOT_FIELDS = [
    ...
    "error_type",
    "error_message",
    "phase16_feedback_daily_history_path",
    "phase16_feedback_daily_latest_path",
    "phase17_feedback_history_acceptance_report_path",
    "phase18_feedback_history_daily_summary_path",
    "records_count",
    "latest_run_id",
    "created_at",
]
...
def validate_phase20_feedback_control_snapshot_payload(*, snapshot_payload: dict) -> dict:
